...
const Feed = () => {
  ...
  const uploadPhoto = async () => {
    ...
    try {
      ...
      const response = await fetch("/users/me/post", requestOptions);
      if (!response.ok) {
  ...
  const tweet = async () => {
    ...
    try {
      ...
      const response = await fetch(`/users/me/tweet`, requestOptions);
      if (!response.ok) {
        const error = new Error(response.error);
        throw error;
      }
  ...
  const getPost = async (p) => {
    ...
    try {
      ...
      const response = await fetch(`/users/me/post?&page=${p}`, requestOptions);
      console.log(response);
