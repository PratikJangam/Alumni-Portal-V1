...
const Profile = () => {
  ...
  const getPosts = async () => {
    try {
      ...
      const response = await fetch("/users/me/myPost", requestOptions);
      const data = await response.json();
      // console.log(data, "🔥🔥🔥");
  ...
  const uploadPhoto = async () => {
    ...
    try {
      ...
      const response = await fetch("/users/me/avatar", requestOptions);
      if (!response.ok) {
        const error = new Error(response.error);
        throw error;
      }
  ...
  const deletePost = async (id) => {
    ...
    try {
      ...
      const response = await fetch(`/users/me/post/${id}`, requestOptions);
      if (!response.ok) {
        const error = new Error(response.error);
        throw error;
      }
